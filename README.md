...
The first principle of the this keyword is the window/ global binding. This is the case when this is refering the the console as a whole or is in the global scope.
The second principle is implicit binding. It is used within a function and refers to whatever we pass into the function.
The third principle is the new binding. This binding method sets the value of this when we call the finction with the new keyword.
The fourth principle is the explicit binding changes what this points to and lets you assign it a new value.
